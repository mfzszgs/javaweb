			...
			<a
				...
				class="STYLE21"> <u>注销</u>
					...
					<span class="STYLE25">&nbsp;<a href="ProFile.jsp"
						class="STYLE25"><em><strong><img src="images/book.png" alt="" style="height: 25px; width: 25px; "/></strong></em><strong style="color: #00F">已接包列表</strong></a></span>
			</label>
			</span>
		</p>
	</form>
		...
		<div class="M_table">
			<table width="960" border="1" align="center" cellpadding="1"
				...
				<tr bgcolor="#EBF4FB">
					...
					<td style="width: 38px; "><input type="checkbox" name="choose" value="<%=rset.getInt("ID")%>">					</td>
				</tr>
